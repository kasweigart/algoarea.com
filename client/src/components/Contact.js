...
const Contact = (props) => {
  ...
  return (
    <div>
      ...
      <i>This site is intended for personal and educational purposes only.</i><br/>
      <p>Feel free to contact me for content improvements, revision, or other related requests.</p>
      <Form
        id="contactForm"
